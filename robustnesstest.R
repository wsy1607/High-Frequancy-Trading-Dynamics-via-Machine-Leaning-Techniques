...
for (i in 1:10){
  ...
  error1.rf[i] <- sum(error.rf[51:100])/100
  error2.rf[i] <- sum(error.rf[101:150])/100
  error3.rf[i] <- sum(error.rf[151:200])/100  
}
error.rf.mean <- c(mean(error1.rf),mean(error2.rf),mean(error3.rf))
error.rf.sd <- c(sd(error1.rf),sd(error2.rf),sd(error3.rf))
